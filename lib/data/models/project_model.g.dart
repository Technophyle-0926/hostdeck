...
extension ProjectModelQuerySortBy
  ...
  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> sortByAppName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'appName', Sort.asc);
    });
  }

  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> sortByAppNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectModelQuerySortThenBy
  ...
  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> thenByAppName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'appName', Sort.asc);
    });
  }

  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> thenByAppNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'appName', Sort.desc);
    });
  }
...
extension ProjectModelQueryWhereDistinct
  ...
  QueryBuilder<ProjectModel, ProjectModel, QDistinct> distinctByAppName({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectModelQueryProperty
  ...
  QueryBuilder<ProjectModel, String, QQueryOperations> appNameProperty() {
    return QueryBuilder.apply(this, (query) {
